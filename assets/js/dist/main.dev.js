  ...
  methods: {
    ...
    changeStar: function changeStar(rez) {
      ...
      var _loop = function _loop(i) {
        var ind = _this4.fav_list.findIndex(function (el) {
    ...
    toggleFav: function toggleFav(imdbID) {
      if (this.fav_list.length !== 0) {
        ...
        if (ind !== -1) {
          ...
          var fav_item = this.result.Search.find(function (el) {
            return el.imdbID === imdbID;
          });
          this.fav_list.push(fav_item);
        }
      } else {
        var _fav_item = this.result.Search.find(function (el) {
          return el.imdbID === imdbID;
        });

        this.fav_list.push(_fav_item);
      }
    ...
    darkTheme: function darkTheme(dark) {
